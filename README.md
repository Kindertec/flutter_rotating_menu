...
- ⚙️ **Highly customizable** - Adjust radius, item count, colors, and more
...
1. **Physics Simulation** - `FrictionSimulation` provides natural deceleration after flinging
2. **Ticker** - Ensures smooth 60fps animation updates
3. **Gesture Detection** - Pan gestures track finger movement and calculate velocity
4. **Trigonometry** - Items are positioned in a circle using `sin` and `cos`
5. **Hooks** - `flutter_hooks` simplifies state management and lifecycle
...
- [flutter_hooks](https://pub.dev/packages/flutter_hooks) - For cleaner state management
- [hooks_riverpod](https://pub.dev/packages/hooks_riverpod) - State management (optional, can be removed)
